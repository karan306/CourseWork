...
def valueIteration(transitions,rewards,states,actions,gamma):
...
def convert_data(filename):
    ...
    return s,a,transitions,rewards,gamma



if __name__=="__main__":
    s,a,transitions,rewards,gamma=convert_data(sys.argv[1])
    V,Pi,t=valueIteration(transitions,rewards,s,a,gamma)
    for i in range(s):
        print(V[i],Pi[i])
    print("iterations",t)
